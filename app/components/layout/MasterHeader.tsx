    ...
    <div className='master__header-dash start'>
     <CompLink vairiants='icon' className='master-aside__logo' href={'/'}>
      <svg
       ...
       x='0px'
       y='0px'
       viewBox='0 0 1900.6 1531.7'
       xmlSpace='preserve'
      >
       <title>Rexan_Logo</title>
       <path
        className='st0'
        d='M1533.6,1136.4c15.6,2.3,29.3,7,41.2,16.8c10.6,8.6,18.1,19.7,26.5,30c5.7,6.9,11.2,14,17.2,20.6
       ...
       <path
        className='st0'
        d='M1087.8,1524.7c4.8-4.2,9-8.2,13.5-11.7c9.6-7.5,16.8-16.9,23.2-27.1c9.4-15.1,14-32.2,20.8-48.5
       ...
       <path
        className='st0'
        d='M882.4,1280.8c8.2-13.3,15.9-26,23.7-38.6c10.4-16.9,20.8-33.7,31.3-50.6c5.5-8.9,10.9-17.8,16.5-26.7
       ...
       <path
        className='st0'
        d='M403.9,1524.6c13.7-16,19-35,21.7-54.7c3.1-22.5,2.5-45.3,1.9-68c-0.4-14.1-1.1-28.2-2-42.2
       ...
       <path
        className='st0'
        d='M0,1139.4c16.3-2.3,32.7-4,49.2-5c8.7-0.5,17.4-0.5,26.1-0.7c11.2-0.2,22.4-0.5,33.6,0.1
       ...
       <path
        className='st0'
        d='M1252.2,873.6H717.5c5.3,13.7,3.3,26.3-5.6,37.4c-5.8,7.3-13.8,12.1-23.2,13.1c-23.7,2.4-40.5-12-42.7-35.3
       ...
       <path
        className='st0'
        d='M812.6,559.2c22.5,3.9,41.4,12.1,55.7,29.9c9.6,12,19.5,23.8,29.4,35.6c11.1,13.2,21.7,26.8,32.7,40.1
       ...
       <path
        className='st0'
        d='M961.6,581.7c21.1,29.9,42.7,58.9,64.5,87.7c11.3,14.9,22.9,29.4,34.8,43.8c16.4,20,33.6,39.2,52.4,56.8
       ...
       <path
        className='st0'
        d='M917.7,47.3c12.2-1.5,23.5-1.8,34.5-4.3c6.8-1.5,12.7-3.1,15.6-11.1c3.4-9.2,7.7-18.1,12.9-26.5
       ...
       <path
        className='st0'
        d='M1301.9,214.7c2-10.4,4-19.8,5.5-29.3c0.8-5.5,2.1-11.1,0.5-16.7c-0.6-2-1.7-3.7-3.2-5.1
       ...
       <path
        className='st0'
        d='M827.9,151c-9.3-2.8-16.6-8.1-24.5-12c-4.8-2.4-9.4-5-14.1-7.4c-3.4-1.7-6.5,0.3-9.3,1.8
       ...
       <path
        className='st0'
        d='M627.3,87.2c4.7,9.7,9.8,18.9,13.5,28.6c3.8,9.8,11.4,12.8,20.5,14.2c10.3,1.5,20.7,2.8,31.5,4.3
       ...
       <path
        className='st0'
        d='M1136.7,152.7c0.4-6.3,1.8-12.5,3.2-18.6c1.9-8,2.7-16.2,2.5-24.3c0-2.1-0.9-4-2.4-5.4
